	...
	public Appointment viewOne(int appointmentId) {
		...
		try {
			...
			while(rsAppointment.next()){ 
				...
				appointment.setUserId(rsAppointment.getInt("userId"));
				appointment.setNurseId(rsAppointment.getInt("serviceId"));
				appointment.setDate(rsAppointment.getString("appointmentDate"));
				appointment.setAppointmentStatus(rsAppointment.getBoolean("appointStatus"));
